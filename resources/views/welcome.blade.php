...
<head>
	...
	<title>Dashboard Aplikasi IT Infra</title>
...
<body>
	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/#"><img src="/img/lintas-logo.png" data-active-url="img/lintas-logo.png" alt=""></a>
			</div>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<h1 class="white typed">Di Dashboard IT Infra Lintasarta</h1>
	...
	<section id="aplikasi" class="section section-padded">
		<div class="cut cut-top"></div>
		<div class="container">
			<div class="row text-center title">
				<h2>Aplikasi</h2>
				<h4 class="light muted">Berikut adalah daftar aplikasi IT Infra yang dapat Anda gunakan</h4>
			</div>
				...
				<div class="col-md-4">
					...
					<div class="service">
						<div class="icon-holder">
							<img src="/img/icons/lintas-simomen.png" alt="" class="icon">
						</div>
						<h4 class="heading">Simomen</h4>
						<p class="description">Adalah sebuah aplikasi inventarisasi barang IT Infrastruktur.</p>
					</div>
					</a>
				</div>
				<div class="col-md-4">
					...
					<div class="service">
						<div class="icon-holder">
							<img src="/img/icons/lintas-qerja.png" alt="" class="icon">
						</div>
						<h4 class="heading">Qerja</h4>
						<p class="description">Adalah sebuah aplikasi pengajuan lembur teknisi IT Infrastruktur.</p>
					</div>
					</a>
				</div>
				<div class="col-md-4">
					...
					<div class="service">
						<div class="icon-holder">
							<img src="/img/icons/lintas-nextapp.png" alt="" class="icon">
						</div>
						<h4 class="heading">Next Aplikasi</h4>
						<p class="description">Aplikasi selanjutnya dari IT Infrastruktur.</p>
					</div>
					</a>
				</div>
			</div>
